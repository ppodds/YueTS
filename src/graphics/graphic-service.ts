...
export class GraphicService {
    ...
    ehentaiBookPreviewEmbed(client: Client, galleryMetadata: GalleryMetadata) {
        const embed = this.info(client, "「以下是這本魔法書的相關資訊...」");
    ...
    nhentaiBookPreviewEmbed(client: Client, galleryResponse: GalleryResponse) {
        const embed = this.info(client, "「以下是這本魔法書的相關資訊...」");
